...
public class WebmailCompose {
	...
	public GetComposeMailResponse sendComposeMail(String oldmsgid, String ref, String ip, String xmailer, String draftuid, String host, String port,String imapport, boolean saveSent, String id, String pass,String fromname, String to, String cc, String bcc, String sub ,String cnt, boolean hasattach, List<String> atchfile, List<String> atchnewfile, String readrec, String pri, String texttype, String filePath)
	{
