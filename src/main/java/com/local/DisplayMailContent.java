...
public class DisplayMailContent {
	  ...
	  static int flg=0;
	  static int inline=0;
	  static String nfilePath="";
	  static boolean ret_Att=false;
	  static String ret_cnt="";
	  static String ret_sub="";
	  static String ret_bou="";
	  static  List<String> attach_nm=new ArrayList<String>();
	  static	List<String> attach_size=new ArrayList<String>();
	  static String icsSt="No";
	  static byte []icsCntt=null;
	  static String icsMethod="";
	  static String icsString="";
	  static String chk_cal="No";
	 ...
	 * @return
	 */
	public GetMailDisplayResponse listWebmailContent(String host, String port, String id, String pass, String uid, String foldername, String filePath)
	{
...
int umsg= folder.getUnreadMessageCount();
 for (int i = 0; i< msg.length; i++)
  ...
  try
	{
	 String fm=MimeUtility.decodeText(from);
	 from=fm;
	}
  catch(Exception ee)
  {
  ...
  try
	{
	 String su=MimeUtility.decodeText(subject);
	 subject=su;
	}
  catch(Exception ee)
  {
	   ...
	   */
	   public static void writePart(Part p) throws Exception {
	     ...
	     // System.out.println("CONTENT-TYPE: " + p.getContentType());
	      ...
	      else if(p.isMimeType("text/calendar"))
	      {
	          ...
	          // InputStream is = (InputStream) o;
	            ...
	            String cntt=IOUtils.toString((InputStream)p.getContent(), "UTF-8");
	    	 ...
	    	 // System.out.println("content type" + p.getContentType());
	    	  ...
	    	  Enumeration headers = p.getAllHeaders();
	    		 ...
	    		 if(h.getName().equalsIgnoreCase("Subject"))
	    		 {
	    			 ...
	    			 try {
	    				 if(ret_sub!=null)
	    				 ret_sub=MimeUtility.decodeText(ret_sub);
	    				 else
	    					 ret_sub="";
	    				} catch (UnsupportedEncodingException e) {
	    					// TODO Auto-generated catch block
	    ...
	    /*  else if (p.isMimeType("image/jpeg")) {
	        ...
	        if(!(chk_cal.equalsIgnoreCase( "Yes") && nm.equalsIgnoreCase("invite.ics")))
	        {
	        attach_nm.add(nm);
	        attach_size.add(""+sz);
	        }
