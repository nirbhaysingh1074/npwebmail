...
public class WebmailAttachment {
	...
	static int flg=0;
	  ...
	  static List<String> flnm= new ArrayList<String>();
	  static   List<String> flnewnm= new ArrayList<String>();
	  static   List<String> flsz= new ArrayList<String>();
...
for (int i = 0; i< msg.length; i++)
 {
	 ...
	 if(repTo.contains("?utf-8?") || repTo.contains("?UTF-8?"))
	  ...
	  try
		{
		 String fm=MimeUtility.decodeText(repTo);
		 repTo=fm;
		}
	  catch(Exception ee)
	  {
	        ...
	        // System.out.println("---------------------------flg="+flg);
	         ...
	         mail_cont="<pre>" +p.getContent()+"</pre>";
	    	  ...
	    	  try
	    	  {
		         ...
		         if(nm.contains("?utf-8?") || nm.contains("?UTF-8?"))
		        	 nm=nm.replaceAll("\"", "");
		   	  try
		   		{
		   		 String fm=MimeUtility.decodeText(nm);
		   		nm=fm;
		   		}
		   	  catch(Exception ee)
		   	  {
