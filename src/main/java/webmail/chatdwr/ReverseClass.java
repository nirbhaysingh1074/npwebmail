...
public class ReverseClass {
	...
	public void refreshInboxDWR(ServerContext serverContext, String loggedUser, String fid, String sub) {
		...
		Browser.withPageFiltered(page, filter, new Runnable() {
			...
			public void run() {
				...
				//utilAll.addFunctionCall("autoWebmailInboxRefreshNP", sub, ""+fid);
					ScriptSessions.addFunctionCall("autoWebmailInboxRefreshNP",  subj, frmid);
						...
						if (presence.getType() == Presence.Type.available) {
							...
							if (mode == Presence.Mode.available || mode == null) {
								...
								if (presence.getStatus() != null) {
									...
									addDivs += "<div id='" + re.getUser() + "name' class='cheat_row'>" +
