...
public class WebmailClient extends WebServiceGatewaySupport {
	...
	public webmail.wsdlnew.GetMailDisplayResponse  displayMailContentRequest(String host,String port, String id, String pass,String uid, String folder, String filePath)
	{
		...
		webmail.wsdlnew.GetMailDisplayResponse  response =dmc.listWebmailContent( host,  port,  id,  pass,  uid,  folder, filePath);
		return response;
	...
	public webmail.wsdlnew.GetComposeMailResponse  comoseMailRequest(String oldmsgid, String ref,String ip, String xmailer, String draftuid, String host, String port,String imapport, boolean savesent, String id, String pass,String fromname, String to, String cc, String bcc, String sub ,String cnt, boolean isattach, List<String> flname, List<String> newflname, String readrec, String pri, String texttype, String filePath)
	{
		...
		webmail.wsdlnew.GetComposeMailResponse response=wcom.sendComposeMail(oldmsgid, ref, ip, xmailer, draftuid, host, port, imapport, savesent, id, pass, fromname, to, cc, bcc, sub, cnt, isattach, flname, newflname, readrec, pri, texttype, filePath);
		return response;
