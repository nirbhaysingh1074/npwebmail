      ...
      <div class="clear"></div>
       ...
       <div class="left_tab_content"  >
        <div class="left_three_box calender_js" > 
          ...
          <!-----------/// MY CALENDER ----------------->
          <div style="cursor: pointer;" class="my_con">My Contacts</div>
          ...
          <div class="left_three_box calender_js" >
          <div style="cursor: pointer;" class="other_con other_bottom_con">Shared with Me</div>
            <div id="shared_contact_folder_div" style="display: block;" class="other_calender_con">
