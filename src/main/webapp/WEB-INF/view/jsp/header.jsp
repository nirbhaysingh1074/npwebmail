...
$(document).ready(function(){ 	
	...
	setTimeout(function(){ getChatBody(); }, 20000);
...
function mailSaveInDraftNew(val, hid_id) {
	...
	if(val==null || val=="")
		{
		var hidval=$("#"+hid_id).val();
		if(hidval!=null && hidval!="")
			{
			if(window.draftProgress!=false)
			{
			mailSaveInDraft();
		...
		<div class="header">
			<div class="header_inner">
				...
				<div class="header_right">
					...
					<div class="new_user" onClick="userinformation(event);">
						<img alt="Embedded Image" src="<%=path_img %>" onerror="getAltImage(this.id)"
							id="<%=path_img_id %>" />
					</div>

					<div class="user_noti">
					<img alt="Notification Image" src="images/notification.png" />
					</div>
					...
					<div class="more_product_content arrow_box_1">
						...
						<ul>
                            ...
                            <div class="brief_ring">
						     ...
						     <li>
                            <a href="http://www.silvereye.in/" target="_blank">
                            <div class="web_ring">
						...
						<div style="width: 170px;">
							...
							<table>
								<tr>
									...
									<td style="padding-right: 2px;" width="20px"><a
										style="cursor: pointer;" name="#5DB2FF"
										onclick="changeHBG(this.name)"> <img
											style="width: 20px !important; height: 20px;"
											src="images/bg7.png" />
									</a></td>
