	...
	//  alert(calender_height);
	  ...
	  $(document.body).on('click', '.share_more' ,function(){
		  ...
		  var select_val = $(this).parent().children().children().val();
		   ...
		   if(select_val=="ur")
             {
               select_get +=      '<option value="ur" selected="selected">Can View </option> <option value="us">Can Manage </option>';
             }
            
             if(select_val=="us")
             {
               select_get +=  '<option value="us" selected="selected">Can Manage </option> <option value="ur" >Can View </option>';
             }
