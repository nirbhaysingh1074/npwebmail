...
//	     								 $('.repeat_every_day').hide();
	     					...
	     					{
	     						showmsg("alert","Sorry event not deleted !")
	     					}
...
//			alert("update cal name : " + calr);
			...
			$.ajax({
					...
					data : {'calendar':calr,'cal_name':cal_name,'cal_location':cal_location,'cal_desc':cal_desc},
					contentType : "application/json",
					success : function(data) {
						...
						if(obj.success == "true")
						{
							showmsg("alert","Calendar successfully updated !");
						}
						$('.cal_setting').hide();
						$('.web_dialog_overlay').hide();
