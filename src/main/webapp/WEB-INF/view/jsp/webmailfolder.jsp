  			...
  			if(fd.isHasChild())
  			{
  				...
  				for(int i=0;i<list1.size();i++)
  				{
  	  	  		...
  	  	  		if(list1.get(i).isHasChild() )
  	  	  		{
  	          		...
  	          		{
  	          			%>
  	  	  			<span id="<%=nm %>"  style="cursor: pointer;" onclick="getWebmailInbox(this.id)">
  	        	    ...
  	        	    {%>
  	  	  			...
  	  	  			<span id="<%=nm %>" class="inactive_fldr">
  	          		<%=list1.get(i).getFolderName() %> 
  	        	    </span>
  	        	    <%
  	        	    }
  			...
  			else
  			{
  				...
  				%>
  	  			<%-- <%=fd.getName() %> --%>
  	  			  ...
  	  			  <div class="child_blank"></div> 
  	  			  <span id="<%=fd.getFolderFullName() %>"   style="cursor: pointer;" onclick="getWebmailInbox(this.id)">
