...
<div class="right-pane"> 
 ...
 <div class="top_three_calender"> 
        ...
        <!---/// FIRST CALENDER ------>
        <div class="first_cal_option new_con_option"><div class="create_cal_icon"></div> Create Calendar </div>
        ...
        <!---/// THIRD CALENDER ------>
        <div class="first_cal_option_2 create_event new_con_option"><div class="create_cal_icon_2"></div>Create Event</div>
    ...
    <!--   <div class="agenda">Agenda</div> -->
      <div class="right_tool_part for_calender">
        <div class="right_tool"> <a  href="#" onclick="refreshCalendar()"> <img src="images/reload.png"> </a> </div>
      ...
      <table class="table">
        ...
        <tr class="end_recur" style="margin-top: 5px;display: none;">
          ...
          <td >
            	...
            	<label>After</label>
            	<input type="number"  disabled="disabled" class="positiveNumber count_input clear_data" name="count_input" id="count_input" value="0" />
...
<!--                            			</tr> -->
    ...
    <div style="padding: 8px; float: left;font-size: 13px">
...
// 	alert("deleted_guest :  "+deletedguest);
	$.ajax({
        type:"get",
        data:{
        	'eventdetails':value,'send_invite_mail':send_invite_mail,'deletedguest':deletedguest
        },
        url:"createEvent",
        async:true,
        dataType: "json",
...
<div class="cal_setting_1">
   <table width="100%">
      <tr> 
       ...
       <tr> 
         <td class="cal_heding">Location:</td>
          <td>
          <input type="text" class="cal_setting_input" id="cal_location" />
          <div class="clear"></div>
          <span>e.g. "San Francisco" or "New York" or "USA."</span>
          </td>
      </tr>
       <tr> 
