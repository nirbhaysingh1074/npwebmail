...
// 	alert("change fldnm="+fldnm);
	...
	else
	{
		...
		$.ajax({
	        ...
	        data: {'hid_old_msg_id': hid_old_msg_id, 'hid_msg_ref': hid_msg_ref, 'draftuid': draftuid, 'to':to, 'cc':cc, 'bcc':bcc, 'sub':sub, 'cntt':cntt, 'read_rec': read_rec, 'ml_priority': ml_priority ,'texttype':texttype},
 ...
 function uploadFormData(){
   // $('#result').html('');
	...
	//alert("second="+window.flszMB)
	  ...
	  if(window.flszMB> 25)
		  {
		  var msg="The uploaded file exceeds the maximum size of 25 MB.";
	  ...
	  var requestPage="${pageContext.request.contextPath}/getconPopupList";
		jQuery.get(requestPage,
			...
			$("#contactLst").html(data);
	            	...
	            	var fpath="/Contacts/Personal Contacts";
...
{
	editor_cnt="<br>"+(String)request.getAttribute("signature");
	signcnt=editor_cnt;
	%>
...
editor_cnt="<br><br><br>"+editor_cnt;

String draft_mail_uid=(String)request.getAttribute("draft_mail_uid");
if(draft_mail_uid!=null && !draft_mail_uid.equalsIgnoreCase(""))
{
%>
<input type="hidden" id="hid_to_draft_mail_uid" value="<%=draft_mail_uid %>" />
<%}
else
{
%>
  ...
  <div class="right_top_pannel right_top_pannel_new setting_pages"> 
                        ...
                        <div class="for_tool">
                           <div id="menu-wrap" class="composed_option">    
                                <ul id="menu">
                                     <li class="menu_space"><a style="cursor: pointer;" onclick="backFromComposeNew()"><img src="images/back_option.png" /></a></li>
                                      <li><a style="cursor: pointer;" onclick="mailSend()">Send </a></li>
                              
                              
                                      <li><a style="cursor: pointer;" onclick="discardCompose()">Discard</a></li>
                                      <li><a style="cursor: pointer;" onclick="mailSaveInDraftFource()">Save Draft</a></li>
                                            ...
                                            <!--   <li><a style="cursor: pointer;">Format As HTML</a></li> -->
                                             <!--  <li>
                                              ...
                                              <li class="read_receipt">
                                                  <a style="cursor: pointer;" onclick="readRec()">Read Receipt <div class="green_plain_text_read"></div></a>
                                              <input type="hidden" value="0" id="hid_read_rec" />
                                              </li>
                                                <!-- <li>
                                                  <a style="cursor: pointer;">Delivery Status Notification</a>
    ...
    <div id="widget" class="setting_scroll" > 
      ...
      <div class="composed_pages">
          ...
          <div class="composed_row full_to">
                 <div class="to_mail" style="cursor: pointer;" onclick="openMyContacts('to')">To</div>
                 ...
                 <!---------// END HERE -------------------->
                 <textarea id="to_id" value="" onblur="mailSaveInDraftNew(this.value,'hid_to_id')"  name="to_id"   class="enter_email new_com_to"></textarea>
      ...
      <div class="clear"></div>
          <!--------------/// CC ROW  STARED HERE -------------->   
           ...
           <div class="composed_row cc_row full_cc">
                 <div class="to_mail cc_left" style="cursor: pointer;" onclick="openMyContacts('cc')">Cc</div>
                ...
                <div class="email_id_info_cc"></div> 
                    ...
                    <!---------/// AFTER FOCUS STARED HERE --------->
                      <textarea id="cc_id"   value="" onblur="mailSaveInDraftNew(this.value,'hid_cc_id')" name="cc_id"  class="enter_email_cc "></textarea>
          ...
          <!------------/// CC ROW END HERE ------------------->
           ...
           <div class="composed_row bcc_hide">
                 <div class="to_mail" style="cursor: pointer;" onclick="openMyContacts('bcc')">Bcc</div>
                 <div class="composed_input bcc_row new_com_bcc">
                  <!----/// EMAIL INFO ------>
                    ...
                    <!---------/// AFTER FOCUS STARED HERE --------->
                     <!------// After Focus div The Show Email ID ------------>
                <textarea id="bcc_id" name="bcc_id"   onblur="mailSaveInDraftNew(this.value,'hid_bcc_id')" class="enter_email_bcc "></textarea> 
                   <input type="hidden" id="hid_bcc_id" value="<%=rep_cc_id %>"/>
                    <!---------/// AFTER FOCUS STARED HERE --------->
         ...
         <div class="written_space">
  	               <textarea cols="100" style="visibility: hidden;" id="editor1" onblur="mailSaveInDraftNew(this.value)" name="editor1" rows="10" class="text_plugins for_plaintext"><%=editor_cnt %></textarea>
...
<div class="briefcase_box">
         ...
         <!---// HEADING --->
           ...
           <div id="contactLst" style="    width: 60%;    float: left;">
